...
export const state = () => ({
  ...
  aboutMe: [
    {
      id: uuidv4(),
      bio: "Interactive Media Designer eager to learn about all aspects of design, recently graduated from the Interactive Media Design program at Algonquin College. With 2+ years of experience working with Adobe Suite and working with the Department of National Defense (DND) / Canadian Armed Forces (CAF). I am ready for anything that might come my way new challenges and to apply my knowledge and experience."
    },
    {
      id: uuidv4(),
      bio: "",
